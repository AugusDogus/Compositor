...
/// Maximum number of hover, active and focus group styles one element follows.
...
pub(crate) enum GroupState {
    ...
    Active,
    /// The group itself owns visible keyboard focus.
    Focus,
}
...
pub struct Element {
    ...
    /// Whether descendants' group-state styles follow this element.
