...
pub struct WindowState {
    ...
    /// Current native cursor override, or `None` for ordinary element cursor styles.
    pub cursor_override: Option<crate::CursorOverrideId>,
...
pub(crate) enum WindowCommand {
    ...
    BeginMove(WindowHandle),
    BeginResize(WindowHandle, winit::window::ResizeDirection),
    ...
    SetCursorOverride(WindowHandle, Option<crate::CursorOverride>),
...
impl WindowCommand {
    pub(crate) fn handle(&self) -> WindowHandle {
        match self {
            ...
            | Self::Move(handle, _)
            | Self::BeginMove(handle)
            | Self::BeginResize(handle, _)
            ...
            | Self::SetCursorOverride(handle, _)
