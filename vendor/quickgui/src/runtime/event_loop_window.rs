        ...
        (|| {
            ...
            match event {
                ...
                WindowEvent::KeyboardInput {
                    ...
                    // X11 replays held keys when focus enters a window. Replaying Return
                    // after a popup commits would activate its owner and reopen it. Keep
                    // synthetic releases so pressed-key state can still reset on focus loss.
